...
object ItemGraph {
  def main(args: Array[String]): Unit = {
    ...
    val rawFeatureMerge = originalSimFeature.map(x => (x._1 + x._2, x)).fullOuterJoin(bigraphSimFeature.map(x => (x._1 + x._2, x)))
      .map(x => {
        if (x._2._1 != None && x._2._2 != None) {
          (x._2._1.get._1, x._2._1.get._2, x._2._1.get._5, x._2._1.get._6 * Math.random(), x._2._1.get._7, x._2._1.get._8 * Math.random(), x._2._2.get._3)
        } else if (x._2._1 != None && x._2._2 == None) {
          (x._2._1.get._1, x._2._1.get._2, x._2._1.get._5, x._2._1.get._6 * Math.random(), x._2._1.get._7, x._2._1.get._8 * Math.random(), 0d)
        } else {
    ...
    sqlContext.sql("drop table if exists s_dg_item_sim_raw_feature")
    featureDF.write.saveAsTable("s_dg_item_sim_raw_feature")
  }
}
